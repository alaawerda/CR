...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487a' => 'get1Dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487aService',
            '2_dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487a' => 'get2Dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487aService',
        ...
        $this->privates = array(
            '1_dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487a' => true,
            '2_dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487a' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487a']) ? $this->services['1_dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487a'] : $this->get1Dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487aService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487a']) ? $this->services['2_dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487a'] : $this->get2Dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487aService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'codedelaroute', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\AppBundle\\Resources\\config\\doctrine') => 'AppBundle\\Entity'));
        $b->setGlobalBasename('mapping');

        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\ChapitreBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\CoursBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\DetailBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\MoniteurBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\QuestionBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\RdvBundle\\Entity'), 6 => ($this->targetDirs[3].'\\src\\ReponseBundle\\Entity'), 7 => ($this->targetDirs[3].'\\src\\TestBundle\\Entity'), 8 => ($this->targetDirs[3].'\\src\\TypepermisBundle\\Entity'), 9 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity')));

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'AppBundle\\Entity');
        $d->addDriver($c, 'ChapitreBundle\\Entity');
        $d->addDriver($c, 'CoursBundle\\Entity');
        $d->addDriver($c, 'DetailBundle\\Entity');
        $d->addDriver($c, 'MoniteurBundle\\Entity');
        $d->addDriver($c, 'QuestionBundle\\Entity');
        $d->addDriver($c, 'RdvBundle\\Entity');
        $d->addDriver($c, 'ReponseBundle\\Entity');
        $d->addDriver($c, 'TestBundle\\Entity');
        $d->addDriver($c, 'TypepermisBundle\\Entity');
        $d->addDriver($c, 'UserBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'ChapitreBundle' => 'ChapitreBundle\\Entity', 'CoursBundle' => 'CoursBundle\\Entity', 'DetailBundle' => 'DetailBundle\\Entity', 'MoniteurBundle' => 'MoniteurBundle\\Entity', 'QuestionBundle' => 'QuestionBundle\\Entity', 'RdvBundle' => 'RdvBundle\\Entity', 'ReponseBundle' => 'ReponseBundle\\Entity', 'TestBundle' => 'TestBundle\\Entity', 'TypepermisBundle' => 'TypepermisBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_66c38a387aeb2936efab0b8d7bffae3985fb35fd76af7d68eb365731440deb50');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ChapitreBundle/Resources/views'), 'Chapitre');
        $instance->addPath(($this->targetDirs[3].'\\src\\CoursBundle/Resources/views'), 'Cours');
        $instance->addPath(($this->targetDirs[3].'\\src\\DetailBundle/Resources/views'), 'Detail');
        $instance->addPath(($this->targetDirs[3].'\\src\\ExamenBundle/Resources/views'), 'Examen');
        $instance->addPath(($this->targetDirs[3].'\\src\\MoniteurBundle/Resources/views'), 'Moniteur');
        $instance->addPath(($this->targetDirs[3].'\\src\\QuestionBundle/Resources/views'), 'Question');
        $instance->addPath(($this->targetDirs[3].'\\src\\RdvBundle/Resources/views'), 'Rdv');
        $instance->addPath(($this->targetDirs[3].'\\src\\ReponseBundle/Resources/views'), 'Reponse');
        $instance->addPath(($this->targetDirs[3].'\\src\\TestBundle/Resources/views'), 'Test');
        $instance->addPath(($this->targetDirs[3].'\\src\\TypepermisBundle/Resources/views'), 'Typepermis');
        $instance->addPath(($this->targetDirs[3].'\\src\\UserBundle/Resources/views'), 'User');
        $instance->addPath(($this->targetDirs[3].'\\src\\UsertestBundle/Resources/views'), 'Usertest');
    ...
    /**
     * Gets the private '1_dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487a' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get1Dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487aService()
    {
        return $this->services['1_dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487a'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487a' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get2Dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487aService()
    {
        return $this->services['2_dca223530c3f1365233e2e7748ac8d2eb2f1bd846e40676a2afea112b2e6487a'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('8Vpnds3+Tj', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WrseTi8SXB', 0, 'TGKpxMLX6w6+4XsvqFLftb', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jq1mJUHfPM', 0, 'TGKpxMLX6w6+4XsvqFLftb', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('e4Sqjm+moW', 0, 'TGKpxMLX6w6+4XsvqFLftb', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a8857113096a3.93781815');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'ChapitreBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ChapitreBundle'),
                    'namespace' => 'ChapitreBundle',
                ),
                'CoursBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\CoursBundle'),
                    'namespace' => 'CoursBundle',
                ),
                'DetailBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\DetailBundle'),
                    'namespace' => 'DetailBundle',
                ),
                'ExamenBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ExamenBundle'),
                    'namespace' => 'ExamenBundle',
                ),
                ...
                'QuestionBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\QuestionBundle'),
                    'namespace' => 'QuestionBundle',
                ),
                'RdvBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\RdvBundle'),
                    'namespace' => 'RdvBundle',
                ),
                'ReponseBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ReponseBundle'),
                ...
                'TypepermisBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\TypepermisBundle'),
                ...
                'UsertestBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\UsertestBundle'),
                    'namespace' => 'UsertestBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ChapitreBundle' => 'ChapitreBundle\\ChapitreBundle',
                'CoursBundle' => 'CoursBundle\\CoursBundle',
                'DetailBundle' => 'DetailBundle\\DetailBundle',
                'ExamenBundle' => 'ExamenBundle\\ExamenBundle',
                'MoniteurBundle' => 'MoniteurBundle\\MoniteurBundle',
                'QuestionBundle' => 'QuestionBundle\\QuestionBundle',
                'RdvBundle' => 'RdvBundle\\RdvBundle',
                'ReponseBundle' => 'ReponseBundle\\ReponseBundle',
                'TestBundle' => 'TestBundle\\TestBundle',
                'TypepermisBundle' => 'TypepermisBundle\\TypepermisBundle',
                'UserBundle' => 'UserBundle\\UserBundle',
                'UsertestBundle' => 'UsertestBundle\\UsertestBundle',
